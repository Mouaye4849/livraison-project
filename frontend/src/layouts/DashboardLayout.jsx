...
const NAV_SECTIONS = [
    ...
    },
    {
        label: "Colis",
        items: [
            { path: "/dashboard/my-colis",           icon: Package,         label: "Mes Colis"     },
            { path: "/dashboard/colis/create",        icon: PlusCircle,      label: "Créer un colis"},
            { path: "/dashboard/colis/public",        icon: Globe,           label: "Colis publics" },
        ],
    },
    {
        label: "Trajets",
        items: [
            { path: "/dashboard/trajets",             icon: Truck,           label: "Mes Trajets"   },
            { path: "/dashboard/trajets/create",      icon: Route,           label: "Créer un trajet"},
            { path: "/dashboard/trajets/with-colis",  icon: Layers,          label: "Trajets + Colis"},
        ],
    },
    {
        label: "Gestion",
        items: [
            { path: "/dashboard/assign",              icon: Link,            label: "Assigner Colis"},
    ...
    return (
        <aside
            ...
            className="
                ...
                dark:border-r dark:border-white/[0.05] border-r border-gray-100
            "
        >
            {/* ── Logo ── */}
            <div className="
                            ...
                            {section.items.map(({ path, icon: Icon, label }) => {
                                ...
                                return (
                                    ...
                                    >
                                        {/* Active left pill */}
                                        {active && (
                                            <span className="absolute left-0 top-1/2 -translate-y-1/2 w-[3px] h-5 rounded-full bg-gradient-to-b from-red-400 to-red-600" />
                                        )}
...
function Navbar({ onLogout, theme, onToggleTheme }) {
    ...
    return (
        ...
        ">
            {/* Red shimmer accent at the very top */}
            ...
            <div className="flex items-center gap-3 h-full px-5">
                ...
                <div className="relative flex-1 max-w-sm">
                    ...
                    <input
                        ...
                        className="
                            w-full pl-9 pr-10 py-2 text-[13px] rounded-xl
                ...
                <div className="ml-auto flex items-center gap-1">
                    ...
                    <div className="relative" ref={dropdownRef}>
                        ...
                        >
                            ...
                            <div className="relative shrink-0">
                                ...
                                <span className="
                                    ...
                                    ring-[1.5px] dark:ring-[#080808] ring-white
                                " />
                            </div>
                            ...
                            <ChevronDown
                                size={12}
                                className={`dark:text-gray-600 text-gray-400 transition-transform duration-200 ${
                        ...
                        {profileOpen && (
                            <div className="
                                dropdown-enter
                                absolute right-0 mt-2 w-56 z-50 rounded-2xl overflow-hidden
                            ...
                            ">
                                ...
                                <div className="px-3 py-2.5 dark:border-b dark:border-white/[0.06] border-b border-gray-100">
                                    ...
                                    >
                                        ...
                                        <div
                                            className={`w-8 rounded-full relative transition-colors duration-200 ${
                                                theme === "dark" ? "bg-gray-700" : "bg-red-500"
                                            }`}
                                            style={{ height: "18px" }}
                                        >
                                            <div className={`
                                ...
                                {/* Actions */}
                                <div className="p-1.5">
                                    <DropdownItem icon={Settings} label="Paramètres"  />
...
export default function DashboardLayout() {
    ...
    // Persist preference and trigger smooth transition — never touches document.documentElement classes
    useEffect(() => {
    ...
    return (
        // The `dark` class lives here, never on <html> — so auth/public pages are untouched
